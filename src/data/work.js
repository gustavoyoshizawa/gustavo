const roles = [
  {
    ...
    nivel: "Freelancer",
    descricao:
      "Atuo como programador front-end freelancer desde novembro de 2023, desenvolvendo interfaces modernas e responsivas, com foco em performance, usabilidade e inovação.",
